function scr_player_knightpep()
{
    ...
    if (sprite_index == spr_knightpep_land || sprite_index == spr_knightpep_walk || sprite_index == spr_knightpep_idle)
    {
        move = (key_left + key_right)
        hsp = (move * movespeed)
    }
    else if (sprite_index == spr_knightpep_attack || sprite_index == spr_knightpep_jump || sprite_index == spr_knightpep_fall || sprite_index == spr_knightpep_doublejump || sprite_index == spr_knightpep_downtrust)
    {
    ...
    if (grounded && vsp > 0)
        jumpstop = 0
    if (input_buffer_jump < 8 && vsp > 0 && grounded && (sprite_index == spr_knightpep_idle || sprite_index == spr_knightpep_downtrust || sprite_index == spr_knightpep_land || sprite_index == spr_knightpep_walk))
    {
        image_index = 0
    ...
    if ((floor(image_index) == (image_number - 1) && sprite_index == spr_knightpep_jump) || ((!grounded) && sprite_index != spr_knightpep_jumpstart && sprite_index != spr_knightpep_jump && sprite_index != spr_knightpep_thunder && sprite_index != spr_knightpep_downtrust && sprite_index != spr_knightpep_doublejump))
        sprite_index = spr_knightpep_fall
    if ((sprite_index == spr_knightpep_downtrust || sprite_index == spr_knightpep_fall || sprite_index == spr_knightpep_doublejump) && grounded && vsp > 0 && (!scr_slope()))
    {
        with (obj_baddie)
        {
    ...
    if grounded
    {
        ...
        else if (sprite_index != spr_knightpep_jumpstart)
            movespeed = 0
    }
    ...
    if (move != 0 && floor(image_index) != 3 && floor(image_index) != 8)
        steppy = 0
    if (sprite_index == spr_knightpep_fall || sprite_index == spr_knightpep_downtrust)
    {
        knightmomentum += 0.35
